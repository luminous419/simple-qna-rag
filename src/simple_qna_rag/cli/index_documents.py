...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="simple-qna-rag-index",
        description="runtime documents 디렉터리의 PDF/TXT를 읽어 FAISS vectorstore를 생성합니다.",
    )
    parser.add_argument("--documents-dir", help="원본 문서 경로 override")
    parser.add_argument("--vectorstore-dir", help="vectorstore 출력 경로 override")
    return parser
...
def main():
    ...
    try:
        ...
        print("\n💡 이제 simple-qna-rag-query 또는 simple-qna-rag-web을 실행하여 질의할 수 있습니다.")
