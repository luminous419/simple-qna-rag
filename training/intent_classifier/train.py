...
출력: models/intent_classifier/ 디렉토리에 학습된 모델 저장
"""
...
class TrainConfig:
    ...
    # 데이터
    train_path: str = str(TRAINING_DIR / "datasets" / "train.jsonl")
    dev_path: str = str(TRAINING_DIR / "datasets" / "dev.jsonl")

    # 출력
    output_dir: str = str(PROJECT_ROOT / "models" / "intent_classifier")
