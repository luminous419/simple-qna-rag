...
def load_intent_classifier(model_dir: str = "intent-bge-m3-softmax"):
    """
...
def classify_intent(question: str, model_dir: str = "intent-bge-m3-softmax") -> str:
    """
    사용자 질문의 의도를 분류
...
def classify_intent_with_confidence(question: str, model_dir: str = "intent-bge-m3-softmax") -> tuple[str, float]:
    """
