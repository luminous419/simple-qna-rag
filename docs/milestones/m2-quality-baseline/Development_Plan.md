...
- 요구사항(수용 기준의 원천): [Development_M2_Quality_Baseline_Requirement.md](Requirement.md) — 이하 "요구사항 문서"
- 작업 단계/결정 사항(원천): [Development_M2_Quality_Baseline_Plan.md](Plan.md) — 이하 "상위 계획"
