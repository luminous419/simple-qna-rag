...
| M4.3-NFR-004 호환성 | M3 baseline bytes 무변경 확인(`git diff --exit-code`); 전체 로컬 pytest suite 1206 PASS(1 skip)(1132 → 1173 → 1206, Hosted CI Remediation Iteration 2가 추가한 19개 신규 테스트 반영) | **PASS(로컬)** |
